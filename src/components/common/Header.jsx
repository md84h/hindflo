                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul className="text-gray-700 flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <a href={path.HOME} className={`${isActivePath(path.HOME) && "text-blue-700 font-bold" } block py-2 pr-4 pl-3 hover:text-blue-700`} aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href={path.ABOUT} className={`${isActivePath(path.ABOUT + "/") && "text-blue-700 font-bold" } block py-2 pr-4 pl-3 hover:text-blue-700`}>About Us</a>
                            </li>
                            {/* <li>
                                <a href="#" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Products</a>
                            </li> */}
                            <li>
                                <a href={path.CONTACT} className={`${isActivePath(path.CONTACT + "/") && "text-blue-700 font-bold" } block py-2 pr-4 pl-3 hover:text-blue-700`}>Contact Us</a>
                            </li>
                            {/* <li>
