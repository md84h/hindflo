...
const Header = () => {
  return (
    <>
        <div className="bg-gray-800 border-gray-200 dark:bg-gray-800">
            <div className="flex items-center text-white px-4 py-4 max-w-screen-xl mx-auto">
                <div>Dealer Distributor Enquiry</div>
                <div className="ml-auto">Mobile Number</div>
            </div>
        </div>
